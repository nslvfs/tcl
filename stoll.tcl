...
bind pub - !stoll pub:stoll

proc pub:stoll {nick uhost handle channel arg} {
global xmsg
set excuse [lindex $xmsg [rand [llength $xmsg]]]
putserv "PRIVMSG $channel :$nick: Herr Dr. Stoll, promovierter Naturwissenschaftler, sagt: \"$excuse\""
}
